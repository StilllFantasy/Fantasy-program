...
# 读取数据
root = 'Cats_Dogs'
dataset_train = datasets.ImageFolder('D:/DATA/Cat_Dog/train_data', transform)
dataset_test = datasets.ImageFolder('D:/DATA/Cat_Dog/test_data', transform)
...
print('正在保存网络...')
try:
    torch.save(model, 'CNN-net.pth')    # 保存整个模型，体积比较大
    print('保存网络成功')
except:
    print('神经网络保存失败')